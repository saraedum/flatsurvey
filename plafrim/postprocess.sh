...
salloc --ntasks=1 --time=72:00:00 srun --pty pixi run flatsurvey-maintenance join  --outdir /beegfs/jrueth/flatsurvey/history/$1 /beegfs/jrueth/flatsurvey/$1/**/*.json /beegfs/jrueth/flatsurvey/history/**/*.json
